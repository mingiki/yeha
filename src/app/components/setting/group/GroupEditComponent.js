...
class GroupEditComponent extends Component {
    constructor(props) {
        ...
        this.group = this.props.group.selectData;

        this.state = {         
            redirectPath : null,
            menus : this.group.menus,
            invalid: {
                name : false
            },
            formValue: {
    ...
    settingGroupEdit = async () => {
        ...
        if (name == null || name == '' || name == undefined) {
          ...
          let result = await this.api.settingGroupEdit(param);
          ...
          if (result.resultCode == "200") {
            ...
            //수정데이터 init
            this.props.GroupActions.SetSelectData(result.resultData);

            this.setState({
                redirectPath : "setting/group/view"
            })
                ...
                <Card>
                    <CardHeader title="그룹 수정">
                        <CardHeaderToolbar>
                            <button
                                type="button"
                                onClick={()=> {this.setState({redirectPath : `/setting/group/view/${this.group.id}`})}}
