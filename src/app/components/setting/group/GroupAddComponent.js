        ...
        this.state = {           
            ...
            menus : [
                ...
                {menuId : "calculation" ,menuName : "정산" ,  isOpen: false , sub : [
                  ...
                  {menuId : "class" ,menuName : "통계", isOpen: false,},              
                ]},         
                ...
                {menuId : "setting" ,menuName : "환경설정" , isOpen: false, sub : [
                  ...
                  {menuId : "class" ,menuName : "수업관리", isOpen: false },   
                  {menuId : "instructor" ,menuName : "직원관리", isOpen: false },
                  {menuId : "group" ,menuName : "권한관리", isOpen: false },
          ...
          let addMenus = this.state.menus.map(menu => {
            if (menu.sub) {
                menu.sub.map(sub => {
                    ...
                    let removeChecked = document.getElementById(sub.menuId+"Delete").checked;
                ...
                let removeChecked = document.getElementById(menu.menuId+"Delete").checked;
